...
Version  : 0.4.1
Release  : 8
URL      : https://cran.r-project.org/src/contrib/reactable_0.4.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/reactable_0.4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670504385
